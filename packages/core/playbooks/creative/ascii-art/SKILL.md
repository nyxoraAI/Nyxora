...
```bash
python3 -m pyfiglet "NYXORA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=NYXORA&font=Slant" | boxes -d stone
```
