...
Built for [Nyxora Agent](https://github.com/NousResearch/nyxora-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/nyxora-agent/skills/creative/ascii-video`](https://github.com/NousResearch/nyxora-agent/tree/main/skills/creative/ascii-video) via PR.
