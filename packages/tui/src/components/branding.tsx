import { Box, Text, useStdout } from '@nyxora/ink'
...
const TAG_FULL = 'Nyxora AI · Messenger of the Digital Gods'
const TAG_MID = 'Messenger of the Digital Gods'
const TAG_TINY = 'Nyxora AI'
const HIDE_BELOW = 34
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · Nyxora AI</Text>
          </Text>
