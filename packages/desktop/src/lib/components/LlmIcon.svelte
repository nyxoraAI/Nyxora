...
{#if provider.toLowerCase() === 'globe'}
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class={className} xmlns="http://www.w3.org/2000/svg">
    <circle cx="12" cy="12" r="10"></circle>
    <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path>
    <path d="M2 12h20"></path>
  </svg>
{:else if provider.toLowerCase() === 'gemini'}
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} class={className} xmlns="http://www.w3.org/2000/svg">
...
{:else if provider.toLowerCase() === '9router'}
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class={className} xmlns="http://www.w3.org/2000/svg">
...
{:else if provider.toLowerCase() === 'groq'}
  <svg width={size} height={size} viewBox="0 0 24 24" stroke={color} fill="none" stroke-width="2.5" stroke-linecap="square" class={className} xmlns="http://www.w3.org/2000/svg">
...
{:else if provider.toLowerCase() === 'xai' || provider.toLowerCase() === 'grok'}
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} class={className} xmlns="http://www.w3.org/2000/svg">
...
{:else if provider.toLowerCase() === 'nvidia' || provider.toLowerCase() === 'nim'}
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color === 'currentColor' ? '#76B900' : color} class={className} xmlns="http://www.w3.org/2000/svg">
