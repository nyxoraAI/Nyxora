...
<div class="space-y-8 w-full">
  <div>
    <div class="flex items-center gap-3 mb-1">
      ...
      <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">DeFi Configuration</h2>
    </div>
    <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Manage API keys for DeFi integrations and aggregators.</p>
    ...
    <div class="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-900/30 p-4 rounded-xl mb-8 flex gap-4 items-start">
      ...
      <p class="m-0 text-[0.85rem] text-yellow-800 dark:text-yellow-200/80 leading-relaxed">
        ...
        <code class="bg-yellow-100 dark:bg-black/20 px-1.5 py-0.5 rounded text-yellow-900 dark:text-yellow-400">~/.nyxora/config/defi_keys.yaml</code>. 
    ...
    <div class="mb-4">
      <h3 class="text-lg font-medium text-blue-600 dark:text-blue-400 mb-2">Dynamic Provider Integrations</h3>
      <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">These fields are dynamically loaded from installed DeFi Aggregator Providers. Provide your API keys to bypass rate limits.</p>
