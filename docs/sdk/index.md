...
Welcome to the **Nyxora SDK Framework**. Nyxora is distributed not just as a monolithic daemon, but as a highly modular, 4-Tier Software Development Kit (SDK).
...
1. **`@nyxora/sdk` (Umbrella Package)**: A plug-and-play bundle for rapid prototyping.
2. **`@nyxora/core-sdk`**: The AI "Brain" for NLP and API execution.
3. **`@nyxora/policy-sdk`**: The rigid security middleware.
4. **`@nyxora-sdk/signer`**: The low-level, zero-trust cryptographic signer. *(Already available on NPM)*
